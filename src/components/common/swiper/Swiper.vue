  ...
  export default {
    ...
    methods: {
      ...
      setTransform(position) {
        ...
        this.swiperStyle['-webkit-transform'] = `translate3d(${position}px),0x0`
      ...
      touchEnd(e) {
        ...
        if (this.distance === 0) {
          ...
          this.currentIndex--
        } else if (this.distance < 0 && currentMove > this.totalWidth * this.moveRatio) {  // 想做移动超过0.5
          this.currentIndex++
        }
